    ...
    <div class="container">
        <div class="row">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.store.update', $user->id)}}" method="POST">
                        @csrf

                        <div class="row justify-content-between">
                            <div class="form-group col-sm-6">
                                <label for="store_name" class="form-label">Store Name</label> <br />
                                <input type="text" class="col-sm-6 form-control" name="store_name" id="store_name" value="{{old('store_name', $user->store->store_name)}}"/>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="col-sm-6 form-control" name="first_name" id="first_name" value="{{old('first_name', $user->first_name)}}"/>
                        ...
                        <div class="row justify-content-between">
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="col-sm-6 form-control" name="last_name" id="last_name" value="{{old('last_name',  $user->last_name)}}"/>
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="text" class="col-sm-6 form-control" name="phone_number" id="phone_number" value="{{old('phone_number',  $user->phone_number)}}"/>
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-sm-12">
                                ...
                                <textarea class="form-control col-sm-12" name="description" id="description" rows="3">{{old('description', $user->store->description)}}</textarea>
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <input class="form-control col-sm-12" id="pac-input" name="address" value="{{old('address', $user->store->address)}}">
